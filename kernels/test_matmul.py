...
Source: https://github.com/ROCm/triton/blob/b36e072fc52e4a9d2222460519f4a8ff669d0f7e/python/perf-kernels/03-matrix-multiplication-all-types.py
"""
...
@triton.autotune(
    configs=[
        ...
        triton.Config(
            ...
            num_warps=8, num_stages=0),
        # Too small block size, tl.dot(a, b) failing
        # triton.Config(
...
def test_benchmark():
    ...
    benchmark.run(save_path="./perf-artifacts/matmul", show_plots=True, print_data=True)
